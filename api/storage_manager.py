...
class StorageManager:
    ...
    def __init__(self, storage_account_name: str = None, container_name: str = "reservations"):
        """
        ストレージマネージャーの初期化
        ...
        try:
            ...
            for blob in blob_list:
                if (blob.metadata and 
                    blob.metadata.get('customer_email', '').lower() == email.lower() and
                    not blob.name.startswith('index/')):
