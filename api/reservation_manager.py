...
class ReservationManager:
    ...
    def _validate_booking_date(self, booking_date: str, class_type: str) -> Dict[str, Any]:
        """
        予約日のバリデーション
    ...
    async def create_reservation(self, reservation_data: Dict[str, Any]) -> Dict[str, Any]:
        ...
        try:
            # 必須フィールドチェック
            required_fields = [
                "class_name", "class_schedule", "booking_date",
    ...
    async def cancel_reservation(self, reservation_id: str, email: str) -> Dict[str, Any]:
        """
        予約キャンセル
        ...
        try:
            ...
            # ステータス更新
            success = await self.storage.update_reservation_status(reservation_id, "cancelled")
    ...
    def get_class_schedules(self) -> Dict[str, Any]:
        ...
        return {
            "success": True,
            "schedules": self.CLASS_SCHEDULES
        }
